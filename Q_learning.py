...
def run_q_learning(env, agent, episodes=10):
    ...
    for episode in range(episodes):
        ...
        if total_reward > best_reward:
            ...
            best_q_table = agent.q_table  # Lưu lại Q-table của agent
...
myMaze = Maze().load(r"C:\Users\admin\Desktop\mazee\maze\maze_8x8.pkl")
env = MazeEnv(myMaze)
agent = QLearningAgent(env)
total_reward, q_table, total_rewards = run_q_learning(env, agent, episodes=1000) # Modified line to unpack 3 values
...
with open(r"C:\Users\admin\Desktop\mazee\policy\q_table_maze_8x8.pkl", 'wb') as f:
   pickle.dump(q_table, f)

# Lấy q_table từ file
with open(r"C:\Users\admin\Desktop\mazee\policy\q_table_maze_8x8.pkl", 'rb') as f:
