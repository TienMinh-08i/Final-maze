...
myMaze = Maze().load(r"C:\Users\admin\Desktop\mazee\maze\maze_32x32.pkl")
env = MazeEnv(myMaze)
...
with open(r"C:\Users\admin\Desktop\mazee\policy\q_table_sarsa_maze_32x32.pkl", 'wb') as f:
    pickle.dump(q_table, f)

# Lấy q_table từ file
with open(r"C:\Users\admin\Desktop\mazee\policy\q_table_sarsa_maze_32x32.pkl", 'rb') as f:
