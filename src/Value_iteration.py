...
def value_iteration(mdp, gamma=0.99, theta=0.0001):
    """
...
myMaze = Maze().load(r"C:\Users\admin\Desktop\src\maze\maze_8x8.pkl")
env = MazeEnv(myMaze)
...
# Lưu policy vào file
with open(r"C:\Users\admin\Desktop\src\vi4x4", 'wb') as f:
    pickle.dump(optimal_policy, f)

# Lấy policy từ file
with open(r"C:\Users\admin\Desktop\src\vi4x4", 'rb') as f:
